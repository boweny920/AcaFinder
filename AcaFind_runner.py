...
parser.add_argument('-v','--HTH_alignment_coverage', nargs='?', default="0.4",help="coverage cut-off for HTH domian hummer search")
...
parser.add_argument('-e','--HTH_hmm',nargs='?',default="HMM/HTH_HMM",help="The hmmdb used to search for HTH containing proteins, default are the Pfam hmms from clan_HTH with model length < 150bp; "
                                                                          "For more strict hmmdb, use 'HTH_HMM_strict' in the HMM folder (Pfam hmms from clan_HTH with model length < 150bp && Contain 'HTH' within domain name); "
                                                                          "You may also build and use your own HTH hmmdb :)")
...
parser.add_argument('-y','--published_acaHMM', nargs='?', default="HMM/AcaHMMs",help="HMM for all 13 publsihed Aca proteins, recommended to use the default hmm provided from us")
...
parser.add_argument('-u','--acaHMM_cov', nargs='?', default=0.6,type=float,help="Coverage cut-off for acaHMM hummer search, recommended to use default")
