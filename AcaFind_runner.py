...
parser.add_argument('-e','--HTH_hmm_strict',action='store_true',help="Provide option -e/--HTH_hmm_strict to use the more strict HTH HMM database (HTH-HMM_strict) for potential Aca protein search in Aca-Acr operons")
...
if args.HTH_hmm_strict != True:
    HTH_hmm="HMM/HTH_HMM"
else: HTH_hmm="HMM/HTH_HMM_strict"
...
Aca_Find_process(fna,gff,faa,
                 ...
                 args.intergenic_dist_in_AcrAca_operon,args.Acr_protein_database,HTH_hmm,args.Acr_Aca_inBetweenGenes,
