...
parser.add_argument('-y','--published_acaHMM', nargs='?', default="HMM/AcaHMMs",help="HMM for all 12 publsihed Aca proteins, recommended to use the default hmm provided from us")
